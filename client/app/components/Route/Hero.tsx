...
const Hero: FC<Props> = () => {
  ...
  // safe banner image value (null when missing or empty)
  const bannerImageUrl =
    typeof data?.layout?.banner?.image?.url === "string" &&
    data.layout.banner.image.url.trim() !== ""
        ...
        <div className="w-full 1000px:flex items-center">
          ...
          <div className="1000px:w-[40%] flex 1000px:min-h-screen items-center justify-end pt-[70px] 1000px:pt-[0] z-10">
            {bannerImageUrl ? (
              ...
              <div
                aria-hidden
                className="w-[300px] h-[300px] bg-gray-100 object-contain 1100px:max-w-[90%] w-[90%] 1500px:max-w-[85%] h-[auto] z-[10]"
              />
            )}
          </div>
