...
exports.loginUser = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!email || !password) {
            return next(new ErrorHandler_1.default("Please enter both credentials.", 400));
        }
...
exports.getAllUsersAdmin = (0, catchAsyncError_1.CatchAsyncError)(async (req, res, next) => {
    try {
